...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/** @jsx React.DOM */
&nbsp;
...
&nbsp;
  handleMarkdownSelectionStore: function(data) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (data.type === 'set') {
...
&nbsp;
  handleUnderlineButtonClick: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    MarkdownEditorActions.makeUnderline();</span>
  },
&nbsp;
...
&nbsp;
  handleMDEditorTabsInteractionStoreUpdated: <span class="fstat-no" title="function not covered" >function(storeState) {</span>
...
<span class="cstat-no" title="statement not covered" >    var htmlContent = this.props.content.replace(/[\n]/g, '  \n');</span>
<span class="cstat-no" title="statement not covered" >    htmlContent = Markdown.toHTML(htmlContent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var styleMarkdownPreviewArea = {</span>
      'height': '90%',
      'width': '100%',
      'padding': '30px 10px',
      'backgroundColor': '#fff',
...
<span class="cstat-no" title="statement not covered" >      divContent = &lt;MarkdownEditorPreview content={this.state.content} /&gt;;</span>
...
&nbsp;
  handleMarkdowEditorStoreUpdated: <span class="fstat-no" title="function not covered" >function(markdownEditorStoreState) {</span>
<span class="cstat-no" title="statement not covered" >    var currentSelection = markdownEditorStoreState.currentSelection;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (currentSelection != null) {</span>
<span class="cstat-no" title="statement not covered" >      this.updateText(this.state.content, currentSelection, markdownEditorStoreState.action);</span>
    }
  },
&nbsp;
  handleMDEditorTabsInteractionStoreUpdated: <span class="fstat-no" title="function not covered" >function(mdEditorTabsInteractionStoreState) {</span>
<span class="cstat-no" title="statement not covered" >    if (mdEditorTabsInteractionStoreState.activeTab != null) {</span>
<span class="cstat-no" title="statement not covered" >      var _inEditMode = mdEditorTabsInteractionStoreState.activeTab === 0;</span>
<span class="cstat-no" title="statement not covered" >      this.setState({inEditMode: _inEditMode});</span>
    }
  },
&nbsp;
  updateText: <span class="fstat-no" title="function not covered" >function(text, selection, actionType) {</span>
<span class="cstat-no" title="statement not covered" >    var token = this.generateMarkdownToken(actionType);</span>
<span class="cstat-no" title="statement not covered" >    var beforeSelectionContent = text.slice(0, selection.selectionStart);</span>
<span class="cstat-no" title="statement not covered" >    var afterSelectionContent = text.slice(selection.selectionEnd, text.length);</span>
<span class="cstat-no" title="statement not covered" >    var updatedText = token.applyTokenTo(selection.selectedText);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _updatedContent = beforeSelectionContent + updatedText + afterSelectionContent;</span>
<span class="cstat-no" title="statement not covered" >    PublicMarkdownEditorActions.updateText(MarkdownUtils.toMarkdown(_updatedContent));</span>
<span class="cstat-no" title="statement not covered" >    this.setState({content: _updatedContent});</span>
  },
&nbsp;
  generateMarkdownToken: <span class="fstat-no" title="function not covered" >function(actionType) {</span>
<span class="cstat-no" title="statement not covered" >    switch (actionType) {</span>
      case 'bold':
<span class="cstat-no" title="statement not covered" >        return new RegularMarkdownToken('**', true);</span>
&nbsp;
      case 'italic':
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jun 13 2016 12:22:08 GMT-0700 (PDT)
</div>
</div>
